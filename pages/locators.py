...
class ProductPageLocators():
    ...
    MESSAGE_PRODUCT_ADD_TO_BASKET = (By.CSS_SELECTOR, "#messages > div:nth-child(1) > div")
    MESSAGE_WITH_PRICE_BASKET = (
        By.CSS_SELECTOR,
        "#messages > div.alert.alert-safe.alert-noicon.alert-info.fade.in > div > p:nth-child(1)"
    )
